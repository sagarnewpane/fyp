...
# CORS settings
CORS_ALLOW_ALL_ORIGINS = False  # Set to True for development, but not recommended for production
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",  # Add your SvelteKit development server URL
    "http://127.0.0.1:5173",
]
